...
class BalanceWithdrawalDriver extends StatefulWidget {
  final VoidCallback onFinishProcess;

  BalanceWithdrawalDriver({this.onFinishProcess});

  @override
  _BalanceWithdrawalDriverState createState() => _BalanceWithdrawalDriverState();
}

class _BalanceWithdrawalDriverState extends State<BalanceWithdrawalDriver> {
  TextEditingController _amountController;
  WalletRepository _walletRepository;
  Bank selectedBank;
  TextEditingController _accountNameController;
  ...
  _submitWithdrawalRequest() async {
    ...
    try {
      ...
      await _walletRepository
          .withdrawFromDriver(new FormData.fromMap(formDetails));
      Navigator.pop(context);
      Navigator.pop(context);
      widget.onFinishProcess();
      AlertBar.dialog(context, 'Withdrawal Successful.', Colors.green,
