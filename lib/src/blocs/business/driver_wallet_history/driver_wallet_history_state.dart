...
class DriverWalletHistoryState {
  ...
  factory DriverWalletHistoryState.empty() {
    return DriverWalletHistoryState(
      isLoading: false,
      isFailure: false,
      isInitial: true,
      isSuccess: false,
  ...
  factory DriverWalletHistoryState.loading(previousState) {
    return DriverWalletHistoryState(
      isLoading: true,
      isFailure: false,
      isInitial: false,
  ...
  factory DriverWalletHistoryState.failure() {
    return DriverWalletHistoryState(
      isLoading: false,
      isFailure: true,
      isInitial: false,
  ...
  factory DriverWalletHistoryState.success(
  ...
  DriverWalletHistoryState copyWith(
      {bool isLoading,
        bool isInitial,
        bool isFailure,
        bool isSuccess,
